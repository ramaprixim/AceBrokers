    ...
    <section style="padding:100px 0px">
        <div class="container">
            <div class="row">
                ...
                <div class="inner-box">
						<h4>A</h4>
							<div class="text-bg" style="text-align:justify;">
						   ...
						   <h4>B</h4>
							...
							<h4>C</h4>
							<div class="text-bg" style="text-align:justify;"><strong>Cable:</strong> Trader jargon for the British Pound Sterling referring to the Sterling/US Dollar exchange rate. Term began due to the fact that the rate was originally transmitted via a transatlantic cable starting in the mid 1800`s.
							...
							<br><strong>Limit Order:</strong> an instruction to open or close a Transaction at a price that may be available in the future which is executed in accordance with the Company’s Order Execution Policy. As an example, if the current price of EUR/USD is 1.07502/1.07522, then a limit order to buy EUR would be at a price below the market price, i.e. 1.0720.
							...
							<br><strong>Market Order:</strong> an instruction to open or close a Transaction at the price currently indicated in the platform which is executed in accordance with the Company’s Order Execution Policy. 
